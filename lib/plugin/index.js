...
class McchartsChartPlugin extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    const metadata = new _core.ChartMetadata({
      description: 'mc charts',
      name: (0, _core.t)('Mccharts'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../Mccharts'))),
      metadata,
...
exports.default = McchartsChartPlugin;