...
const config = {
  ...
  controlPanelSections: [_chartControls.sections.legacyTimeseriesTime, {
    ...
    controlSetRows: [['color_scheme'], [{
      ...
      config: {
        type: 'SelectControl',
        label: (0, _core.t)('Chart Type'),
        default: 'pie',
        choices: [// [value, label]
        ['pie', 'Pie Chart'], ['line', 'Line Chart'], ['bar', 'Bar Chart'], ['hbar', 'Horizontal Bar Chart'], ['doughnut', 'Doughnut Chart'], ['multibar', 'Multi Type Bar'], ['collTbl', 'Collapse Table']],
        renderTrigger: true,
        description: (0, _core.t)('Chart types')
      }
    }], [{
      name: 'number_type',
      config: {
        ...
        default: 'fi-FI',
        choices: [// [value, label]
        ['fi-FI', 'Finnish'], ['en-US', 'Englsih']],
        renderTrigger: true,
        description: (0, _core.t)('Number Format')
      }
    }]]
  }]
};
