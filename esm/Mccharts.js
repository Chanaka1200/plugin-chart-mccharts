...
import 'react-tabs/style/react-tabs.css'; // The following Styles component is a <div> element, which has been styled using Emotion
...
export default function Mccharts(props) {
  ...
  const rootElem = /*#__PURE__*/createRef(); // Often, you just want to get a hold of the DOM and go nuts.
  ...
  if (chartType === 'line') {
    ...
    chartHtml = ___EmotionJSX(Pie, {
      data: chartData,
      options: pieOptions
    });
  } else if (chartType === 'bar') {
    chartHtml = ___EmotionJSX(Bar, {
      data: chartData
    });
    ...
    chartHtml = ___EmotionJSX(Doughnut, {
      data: chartData
    });
    ...
    chartHtml = ___EmotionJSX("div", null, ___EmotionJSX("div", {
      className: "chart-header"
    }, ___EmotionJSX("div", {
      className: "chart-count-item"
    }, ___EmotionJSX("h3", null, qWaitingTimeAvg, " ", ___EmotionJSX("br", null), " ", ___EmotionJSX("small", null, "Queue Time"))), ___EmotionJSX("div", {
      className: "chart-count-item"
    }, ___EmotionJSX("h3", null, newCountAvg, " ", ___EmotionJSX("br", null), " ", ___EmotionJSX("small", null, "New Count")))), ___EmotionJSX(Bar, {
  ...
  if (chartType === 'collTbl') {
    ...
    }, ___EmotionJSX("thead", null, ___EmotionJSX("tr", null, ___EmotionJSX("th", {
      className: "uk-table-shrink"
    }), ___EmotionJSX("th", {
      className: "uk-table-shrink"
    }), ___EmotionJSX("th", {
      className: "uk-table-shrink"
    }, "Avatar"), ___EmotionJSX("th", null, "Fullname"), ___EmotionJSX("th", null, "City"), ___EmotionJSX("th", null, "Registered"))), ___EmotionJSX("tbody", null, users.map(name => {
      return ___EmotionJSX("div", null, ___EmotionJSX("tr", {
        key: "main",
        onClick: () => showLittle()
      }, ___EmotionJSX("td", {
        className: "uk-text-nowrap"
      }, "DD"), ___EmotionJSX("td", null, "VV"), ___EmotionJSX("td", null, "Test"), ___EmotionJSX("td", null, "AA"), ___EmotionJSX("td", null, "VV"), ___EmotionJSX("td", null, "VV")), showText ? ___EmotionJSX("div", {
    ...
    return ___EmotionJSX(Styles, {
      ...
      height: height,
      width: width
    }, ___EmotionJSX(Tabs, null, ___EmotionJSX(TabList, null, ___EmotionJSX(Tab, null, "Tyojonon Tilanne"), ___EmotionJSX(Tab, null, "Tyojonon Tilanne Tunneittain")), ___EmotionJSX(TabPanel, null, chartHtml), ___EmotionJSX(TabPanel, null, ___EmotionJSX("h2", null, "Any content 2"))), ___EmotionJSX("div", {
      id: "tooltip"
    }));
  }
}
